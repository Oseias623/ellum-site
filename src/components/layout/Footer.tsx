    ...
    <footer className="bg-navy text-white">
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          {/* Contato */}
          <div>
            <h4 className="font-serif text-lg text-gold mb-4">Contato</h4>
            <ul className="space-y-2 text-sm text-gray-400">
              ...
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:contato@ellumecc.com" className="hover:text-white transition-colors">
        ...
        <div className="mt-12 pt-8 border-t border-white/10 text-center text-sm text-gray-500">
          <p>&copy; {new Date().getFullYear()} ELLUM Escola Cristã Clássica. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  );
